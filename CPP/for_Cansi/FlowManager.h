...
public:
    ...
    // 线上项目
    //
    const char *ROOT_DIR = "/Users/dev/Documents/Andorid_Work/Work_6/sheepproject/buildAndroid/jsb-link/frameworks/runtime-src/proj.android-studio/";
    const char *WORK_DIR = "lib_CanSi/work_dir/";
