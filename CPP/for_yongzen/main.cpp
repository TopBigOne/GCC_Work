...
auto        rootDir          = "/Users/dev/Documents/GCC_Work/CPP/for_yongzen/";
...
void realEncryptString(const char *oriStr);
...
int test_fopen() {
    // input.txt
    FILE *file = fopen("/Users/dev/Documents/GCC_Work/CPP/for_Cansi/example.bin", "wb");
    if (file == NULL) {
...
void testZlib() {
    ...
    TestZlib testZlib;
    char     *inFilename     = "/Users/dev/Documents/GCC_Work/CPP/for_Cansi/pratice_openssl/test_classes.dex";
    char     *middleFilename = "/Users/dev/Documents/GCC_Work/CPP/for_Cansi/pratice_openssl/ttt_middle";
    char     *outfilename    = "/Users/dev/Documents/GCC_Work/CPP/for_Cansi/pratice_openssl/Zlib_result.dex";
...
void testEncryptString() {
    ...
    realEncryptString("parseJson");
    realEncryptString("execSweet");
    realEncryptString("JNI_OnLoad");
    realEncryptString("JNI_OnUnload");
    realEncryptString("Post success");
    realEncryptString("knockDoor");
    realEncryptString("The Referrer is already exist.");
    realEncryptString("handleAdId");
    realEncryptString("jar");
    realEncryptString("The AdId is already exist.");

}


void realEncryptString(const char *oriStr) {
    puts("realEncryptString ");
